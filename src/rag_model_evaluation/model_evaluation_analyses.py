...
plt.figtext(0.5, 0.02, "with RAG", wrap=True, horizontalalignment='center', fontsize=8)
#plt.show()
...
ax.annotate('with RAG',xy = (0.89, 0.007),xycoords='axes fraction',ha='left',va="center",fontsize=10)
...
ax.annotate('Temperature is 0.3',xy = (0, -0.1),xycoords='axes fraction',ha='left',va="center",fontsize=6)
ax.annotate('with RAG',xy = (0.9, 0.007),xycoords='axes fraction',ha='left',va="center",fontsize=10)
